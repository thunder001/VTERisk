...
devpath = os.path.join(src_path ,'logs_transformer_vte/L/12_16/', "64596c36a651b56539a1cef58399c408.results.dev_preds")

testpath = os.path.join(src_path ,'logs_transformer_vte/L/12_16/', "64596c36a651b56539a1cef58399c408.results.test_preds")
