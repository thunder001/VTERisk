...
test1 = read.csv('Mb1_test_1_28.csv')
test2 = read.csv('Mb2_test_1_28.csv')
test3 = read.csv('Mb3_test_1_28.csv')
test4 = read.csv('Mb4_test_1_28.csv')
...
Dev3_balanced2 = redo_frequency_on_dev(Pdev3, P3,d1 = 2, d2 = .25, eps = -.5) #redo_frequency_on_dev(Pdev3, P3,d1 = 4, d2 = -1, eps = -2)
