...
test1 = read.csv('M1_test_1_25.csv')
test2 = read.csv('M2_test_1_25.csv')
test3 = read.csv('M3_test_1_25.csv')
test4 = read.csv('M4_test_1_25.csv')
...
Mdev = read.csv('totM_dev_1_25.csv')
Mdev$X = NULL
...
# test others 
Dev1_balanced2 = redo_frequency_on_dev(Pdev1, P1, d1 = 3, d2 = .5, eps = -1.5)
Dev2_balanced2 = redo_frequency_on_dev(Pdev2, P2,d1 = 3.25, d2 = -.5, eps = -.5)
Dev3_balanced2 = redo_frequency_on_dev(Pdev3, P3,d1 = 3.5, d2 = -.5, eps = -1)
Dev4_balanced2 = redo_frequency_on_dev(Pdev4, P4,d1 = 5, d2 = -.5, eps = -1)

#Dev4_balanced2 = redo_frequency_on_dev(Pdev4, P4,d1 = 4, d2 = -.5, eps = -1)
