...
train1 = glm(  y ~l, family = 'binomial', data = devs$Y1, weights =wt1 )
train2 = glm(  y ~l, family = 'binomial', data = devs$Y2, weights =wt2 )
...
pred1 = predict(train1, tests$Y1, type = 'response')
pred2 = predict(train2, tests$Y2, type = 'response')
