...
if __name__ == "__main__":
    ...
    parser.add_argument("--result_dir", type=str, default='results/attribute', help="Path of the master experiment config")
    ...
    # cwd = os.getcwd()
    # os.chdir("results/attribute")
    # os.makedirs("figures", exist_ok=True)
    os.makedirs(args.result_dir, exist_ok=True)
    for log_dir, exp_id, exclusion in zip(config['log_dir'],config['exp_id'],config['exclusion']):

        with open(os.path.join(log_dir, "{}.results.test_attribution_{}".format(exp_id, args.month_idx)), 'rb') as f:
        ...
        html_df.to_html('{}/figures/attribution_{}_{}.html'.format(args.result_dir, args.month_idx, exclusion), 
        ...
        html_df.to_html('{}/figures/weighted_attribution_{}_{}.html'.format(args.result_dir, args.month_idx, exclusion), 
